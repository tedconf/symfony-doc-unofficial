...
e ripopoliamo il database con le nostre fixture:
    ...
    $ php symfony propel:build-all-loadd --no-confirmation
...
dedicata:[`sfPropelPager`](http://www.symfony-project.org/api/1_3/sfPropelPager).
...
![Paginazione](http://www.symfony-project.org/images/jobeet/1_3/07/pagination.png)
