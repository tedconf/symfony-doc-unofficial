...
>[widgets](http://www.symfony-project.org/api/1_3/widget) e
>[validatori](http://www.symfony-project.org/api/1_3/validator). Le API
...
>nuovi campi a un form base, quesi non appariranno automagicamente nel form
>(pernsare a un modello in cui si aggiunge una nuova colonna alla tabella correlata).
...
![flusso del Form](http://www.symfony-project.org/images/jobeet/1_3/10/form_flow.png)
...
![Lavoro non attivato](http://www.symfony-project.org/images/jobeet/1_3/10/not_activated.png)

![Lavoro attivato](http://www.symfony-project.org/images/jobeet/1_3/10/activated.png)
