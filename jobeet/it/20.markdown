...
>canale symfony plugin, ed installarlo attraverso il task `plugin:install`.
...
Ora, lanciando `propel:build-all-load`, symfony genererà i file dentro
...
[`sfEvent`](http://www.symfony-project.org/api/1_3/sfEvent).
...
![Architettura dei plugin](http://www.symfony-project.org/images/jobeet/1_3/20/plugin_architecture.png)
