...
Personalizzazione degli oggetti core di symfony (aka factories)
---------------------------------------------------------------
...
modificare il comportamento predefinito di queste classi, modificando i parametri da inviare a loro.
