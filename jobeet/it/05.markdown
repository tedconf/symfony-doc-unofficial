...
sarete abituati ad URL del tipo `/job.php?id=1`. Come fa symfony a farli funzionare?
...
della classe [`sfRoute`](http://www.symfony-project.org/api/1_3/sfRoute). Questa
...
[`sfRequestRoute`](http://www.symfony-project.org/api/1_3/sfRequestRoute) ed
...
[~`sfPropelRoute`~](http://www.symfony-project.org/api/1_3/sfPropelRoute),
...
![404 con sfPropelRoute](http://www.symfony-project.org/images/jobeet/1_3/05/404_propel_route.png)
