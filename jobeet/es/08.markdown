...
>**Note**: Los comandos de linea de Windows desafortunadamente no pueden resaltar los resultados de la prueba en colores rojo ni verde.
...
![pruebas unitarias harness](http://www.symfony-project.org/images/jobeet/1_2/08/test_harness.png)
