...
>una mirada a la [i18n API](http://www.symfony-project.org/api/1_2/i18n) para
>más detalles.
...
>**TIP**
<propel>
>Como `propel:build-all-load` remueve todas las tablas y los datos de la base de datos,
</propel>
<doctrine>
>Como `doctrine:build-all-reload` remueve todas las tablas y los datos de la base de datos,
</doctrine>
...
Debido a un error en symfony 1.2.1, es necesario comentar el title` en la sección `edit`:
...
En el grupo de helper [`Date`](http://www.symfony-project.org/api/1_2/DateHelper) 
:
...
En el grupo de helper [`Number`](http://www.symfony-project.org/api/1_2/NumberHelper) :
...
En el grupo de helper [`I18N`](http://www.symfony-project.org/api/1_2/I18NHelper) :
