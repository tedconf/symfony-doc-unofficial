...
or even just [partials or components](#chapter_21_partial_and_component_cache).
You can also [remove the cache](#chapter_21_removing_the_cache) manually.
 ...
 * [`factories.yml`](#chapter_22_the_factories)
...
[view cache manager](#chapter_21_removing_the_cache).

These core objects are managed by the
[`sfContext` object](#chapter_21_sidebar_the_sfcontext_class), and
they are configured via the [factories](#chapter_22_the_factories).
...
[cache layer](#chapter_21_testing_the_cache) and the
<propel>
