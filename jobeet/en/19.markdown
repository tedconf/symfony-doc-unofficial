...
>a look at the [i18n API](http://www.symfony-project.org/api/1_2/i18n) for
>more details.
...
In the [`Date`](http://www.symfony-project.org/api/1_2/DateHelper) helper
group:
...
In the [`Number`](http://www.symfony-project.org/api/1_2/NumberHelper) helper
group:
...
In the [`I18N`](http://www.symfony-project.org/api/1_2/I18NHelper) helper
group:
