...
that is a nightmare to maintain. It was fast to build, but over time, it's
more and more difficult to make changes, especially because nobody except you
...
A symfony ~template|Templates~ is just a plain PHP file. In the layout template, you
...
![The job module with a layout and assets](http://www.symfony-project.org/images/jobeet/1_3/04/job_layout_assets.png)
...
the other hand, using the `use_stylesheet()` ~helper|Helpers~ is more flexible and
...
Each ~action|Action~ is represented by a method of a class. For the job homepage, the
...
By default, the ~template|Templates~ name associated with an action is deduced by symfony
...
which name begins with `get` and the ~camelCased|Code Formatting~ column name 
...
![Homepage](http://www.symfony-project.org/images/jobeet/1_3/04/homepage.png)
...
![Job page](http://www.symfony-project.org/images/jobeet/1_3/04/job.png)
...
![404 error in the dev environment](http://www.symfony-project.org/images/jobeet/1_3/05/404_dev.png)

![404 error in the prod environment](http://www.symfony-project.org/images/jobeet/1_3/05/404_prod.png)
...
>**TIP**
>The [`sfAction`](http://www.symfony-project.org/api/1_3/sfAction),
>[`sfRequest`](http://www.symfony-project.org/api/1_3/sfRequest), and
>[`sfResponse`](http://www.symfony-project.org/api/1_3/sfResponse) classes
>provide a lot of other useful methods. Don't hesitate to browse the
>[API documentation](http://www.symfony-project.org/api/1_3/) to learn more
