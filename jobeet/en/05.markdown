...
How does symfony determines the action to call based on this URL? Why is the
...
[~`sfPropelRoute`~](http://www.symfony-project.org/api/1_3/sfPropelRoute) as
...
![404 with sfPropelRoute](http://www.symfony-project.org/images/jobeet/1_3/05/404_propel_route.png)
