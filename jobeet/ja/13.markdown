...
`myUser`クラスはデフォルトの[`sfUser`](http://www.symfony-project.org/api/1_3/sfUser)基底クラスをアプリケーション固有のふるまいでオーバーライドします:
...
![求人履歴](http://www.symfony-project.org/images/jobeet/1_3/13/job_history.png)
...
>**NOTE**
>[`sfParameterHolder`](http://www.symfony-project.org/api/1_3/sfParameterHolder)クラスはパラメーターを保存するために`sfRequest`によっても使われます。
...
![ログイン](http://www.symfony-project.org/images/jobeet/1_3/13/login.png)
...
![Webデバッグツールバー](http://www.symfony-project.org/images/jobeet/1_3/13/web_debug.png)
...
デフォルトでは、`myUser`クラスは[`sfBasicSecurityUser`](http://www.symfony-project.org/api/1_3/sfBasicSecurityUser)を継承し、`sfUser`は継承しません。
...
![sfGuardPluginのログイン](http://www.symfony-project.org/images/jobeet/1_3/13/sf_guard_login.png)
...
![バックエンドのメニュー](http://www.symfony-project.org/images/jobeet/1_3/13/menu.png)
...
symfonyブラウザーは~Cookie~をシミュレートするので、組み込みの[`sfTesterUser`](http://symfony-project.org/api/1_3/sfTesterUser)テスターによって使われるユーザーのふるまいをテストするのはとても簡単です。
