...
Tutte le impostazioni hanno il prefisso `app_` perchè la classe `sfConfig` 
...
[consapevolezza dell'ambiente](#chapter_03_consapevolezza_dellambiente) e 
...
che possono mutare nel tempo (pensate ad un indirizzo email). E' inoltre il posto
...
>**NOTE**
>Il file di configurazione `app.yml` è memorizzato in cache sottoforma di file 
