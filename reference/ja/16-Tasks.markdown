 ...
 * グローバルタスク
   * [`help`](#chapter_16_help)
   * [`list`](#chapter_16_list)
 * [`app`](#chapter_16_app)
   * [`app::routes`](#chapter_16_app_routes)
 * [`cache`](#chapter_16_cache)
   * [`cache::clear`](#chapter_16_cache_clear)
 * [`configure`](#chapter_16_configure)
   * [`configure::author`](#chapter_16_configure_author)
   * [`configure::database`](#chapter_16_configure_database)
 * [`doctrine`](#chapter_16_doctrine)
   * [`doctrine::build-all`](#chapter_16_doctrine_build_all)
   * [`doctrine::build-all-load`](#chapter_16_doctrine_build_all_load)
   * [`doctrine::build-all-reload`](#chapter_16_doctrine_build_all_reload)
   * [`doctrine::build-all-reload-test-all`](#chapter_16_doctrine_build_all_reload_test_all)
   * [`doctrine::build-db`](#chapter_16_doctrine_build_db)
   * [`doctrine::build-filters`](#chapter_16_doctrine_build_filters)
   * [`doctrine::build-forms`](#chapter_16_doctrine_build_forms)
   * [`doctrine::build-model`](#chapter_16_doctrine_build_model)
   * [`doctrine::build-schema`](#chapter_16_doctrine_build_schema)
   * [`doctrine::build-sql`](#chapter_16_doctrine_build_sql)
   * [`doctrine::data-dump`](#chapter_16_doctrine_data_dump)
   * [`doctrine::data-load`](#chapter_16_doctrine_data_load)
   * [`doctrine::dql`](#chapter_16_doctrine_dql)
   * [`doctrine::drop-db`](#chapter_16_doctrine_drop_db)
   * [`doctrine::generate-admin`](#chapter_16_doctrine_generate_admin)
   * [`doctrine::generate-migration`](#chapter_16_doctrine_generate_migration)
   * [`doctrine::generate-migrations-db`](#chapter_16_doctrine_generate_migrations_db)
   * [`doctrine::generate-migrations-models`](#chapter_16_doctrine_generate_migrations_models)
   * [`doctrine::generate-module`](#chapter_16_doctrine_generate_module)
   * [`doctrine::generate-module-for-route`](#chapter_16_doctrine_generate_module_for_route)
   * [`doctrine::insert-sql`](#chapter_16_doctrine_insert_sql)
   * [`doctrine::migrate`](#chapter_16_doctrine_migrate)
   * [`doctrine::rebuild-db`](#chapter_16_doctrine_rebuild_db)
 * [`generate`](#chapter_16_generate)
   * [`generate::app`](#chapter_16_generate_app)
   * [`generate::module`](#chapter_16_generate_module)
   * [`generate::project`](#chapter_16_generate_project)
   * [`generate::task`](#chapter_16_generate_task)
 * [`i18n`](#chapter_16_i18n)
   * [`i18n::extract`](#chapter_16_i18n_extract)
   * [`i18n::find`](#chapter_16_i18n_find)
 * [`log`](#chapter_16_log)
   * [`log::clear`](#chapter_16_log_clear)
   * [`log::rotate`](#chapter_16_log_rotate)
 * [`plugin`](#chapter_16_plugin)
   * [`plugin::add-channel`](#chapter_16_plugin_add_channel)
   * [`plugin::install`](#chapter_16_plugin_install)
   * [`plugin::list`](#chapter_16_plugin_list)
   * [`plugin::publish-assets`](#chapter_16_plugin_publish_assets)
   * [`plugin::uninstall`](#chapter_16_plugin_uninstall)
   * [`plugin::upgrade`](#chapter_16_plugin_upgrade)
 * [`project`](#chapter_16_project)
   * [`project::clear-controllers`](#chapter_16_project_clear_controllers)
   * [`project::deploy`](#chapter_16_project_deploy)
   * [`project::disable`](#chapter_16_project_disable)
   * [`project::enable`](#chapter_16_project_enable)
   * [`project::freeze`](#chapter_16_project_freeze)
   * [`project::permissions`](#chapter_16_project_permissions)
   * [`project::unfreeze`](#chapter_16_project_unfreeze)
   * [`project::upgrade1.1`](#chapter_16_project_upgrade1_1)
   * [`project::upgrade1.2`](#chapter_16_project_upgrade1_2)
 * [`propel`](#chapter_16_propel)
   * [`propel::build-all`](#chapter_16_propel_build_all)
   * [`propel::build-all-load`](#chapter_16_propel_build_all_load)
   * [`propel::build-filters`](#chapter_16_propel_build_filters)
   * [`propel::build-forms`](#chapter_16_propel_build_forms)
   * [`propel::build-model`](#chapter_16_propel_build_model)
   * [`propel::build-schema`](#chapter_16_propel_build_schema)
   * [`propel::build-sql`](#chapter_16_propel_build_sql)
   * [`propel::data-dump`](#chapter_16_propel_data_dump)
   * [`propel::data-load`](#chapter_16_propel_data_load)
   * [`propel::generate-admin`](#chapter_16_propel_generate_admin)
   * [`propel::generate-module`](#chapter_16_propel_generate_module)
   * [`propel::generate-module-for-route`](#chapter_16_propel_generate_module_for_route)
   * [`propel::graphviz`](#chapter_16_propel_graphviz)
   * [`propel::init-admin`](#chapter_16_propel_init_admin)
   * [`propel::insert-sql`](#chapter_16_propel_insert_sql)
   * [`propel::schema-to-xml`](#chapter_16_propel_schema_to_xml)
   * [`propel::schema-to-yml`](#chapter_16_propel_schema_to_yml)
 * [`test`](#chapter_16_test)
   * [`test::all`](#chapter_16_test_all)
   * [`test::coverage`](#chapter_16_test_coverage)
   * [`test::functional`](#chapter_16_test_functional)
   * [`test::unit`](#chapter_16_test_unit)
...
例えば、`frontend`アプリケーションのキャッシュをクリアするには:
