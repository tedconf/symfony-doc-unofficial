...
デフォルトの値をあなたが選んだ一意的な秘密の文字列に変更することを強くおすすめします。
...
デバッグメッセージにおいて、`sf_file_link_format`もしくはPHPの`xdebug.file_link_format`設定の値がセットされている場合、ファイルパスがクリック可能なリンクになります。
たとえば、TextMateでファイルを開きたい場合、次の値を使います:
