...
`sfEvent`コンストラクタは3つの引数を受け取ります:
  ...
  * イベントの"subject"(大抵の場合、これはイベントを通知するオブジェクトだが
    `null`にもなる)
  * イベントの名前
  * リスナーに渡すパラメータの配列
...
リスナーはイベントを最初の引数として受け取ります。イベントオブジェクトはイベントの情報を取得するための
いくつかのメソッドを持ちます:
...
`notifyUntil()`メソッドは`true`の値を返すことで1つのリスナーがチェーンを停止するまで
すべてのリスナーを通知します。

チェーンを停止するリスナーは`setReturnValue()`メソッドを呼び出すこともできます。

notifierはリスナーは`isProcessed()`メソッドを呼び出すことで
処理されたイベントを持つことをチェックできます:
 ...
 * [`application`](#chapter_15_application)
   * [`application.log`](#chapter_15_application_log)
 * [`command`](#chapter_15_command)
   * [`command.log`](#chapter_15_command_log)
   * [`command.pre_command`](#chapter_15_command_pre_command)
   * [`command.post_command`](#chapter_15_command_post_command)
   * [`command.filter_options`](#chapter_15_command_filter_options)
 * [`configuration`](#chapter_15_configuration)
   * [`configuration.method_not_found`](#chapter_15_configuration_method_not_found)
 * [`component`](#chapter_15_component)
   * [`component.method_not_found`](#chapter_15_component_method_not_found)
 * [`context`](#chapter_15_context)
   * [`context.load_factories`](#chapter_15_context_load_factories)
 * [`controller`](#chapter_15_controller)
   * [`controller.change_action`](#chapter_15_controller_change_action)
   * [`controller.method_not_found`](#chapter_15_controller_method_not_found)
   * [`controller.page_not_found`](#chapter_15_controller_page_not_found)
 * [`plugin`](#chapter_15_plugin)
   * [`plugin.pre_install`](#chapter_15_plugin_pre_install)
   * [`plugin.post_install`](#chapter_15_plugin_post_install)
   * [`plugin.pre_uninstall`](#chapter_15_plugin_pre_uninstall)
   * [`plugin.post_uninstall`](#chapter_15_plugin_post_uninstall)
 * [`request`](#chapter_15_request)
   * [`request.filter_parameters`](#chapter_15_request_filter_parameters)
   * [`request.method_not_found`](#chapter_15_request_method_not_found)
 * [`response`](#chapter_15_response)
   * [`response.method_not_found`](#chapter_15_response_method_not_found)
   * [`response.filter_content`](#chapter_15_response_filter_content)
 * [`routing`](#chapter_15_routing)
   * [`routing.load_configuration`](#chapter_15_routing_load_configuration)
 * [`task`](#chapter_15_task)
   * [`task.cache.clear`](#chapter_15_task_cache_clear)
 * [`template`](#chapter_15_template)
   * [`template.filter_parameters`](#chapter_15_template_filter_parameters)
 * [`user`](#chapter_15_user)
   * [`user.change_culture`](#chapter_15_user_change_culture)
   * [`user.method_not_found`](#chapter_15_user_method_not_found)
   * [`user.change_authentication`](#chapter_15_user_change_authentication)
 * [`view`](#chapter_15_view)
   * [`view.configure_format`](#chapter_15_view_configure_format)
   * [`view.method_not_found`](#chapter_15_view_method_not_found)
 * [`view.cache`](#chapter_15_view_cache)
   * [`view.cache.filter_content`](#chapter_15_view_cache_filter_content)
...
このイベントは大抵のsymfonyのコアコンポーネントによって通知されます。
...
これはすべてのコアクラスが初期化することで通知される最初のイベントです。
...
| パラメータ| 説明
| --------- | -----------
| `module`  | 404エラーを生成したモジュールの名前
| `action`  | 404エラーを生成したアクションの名前
